...
const Nav = () => {
    return (
        <div className="flex overflow-hidden justify-center ">
            ...
            <div className="fixed py-1 2xl:mt-3.5 z-100 font-sex flex justify-center backdrop-blur-lg mt-1 border border-gray-500 text-gray-300 rounded-lg gap-2.5 px-0.5 2xl:py-2 2xl:px-10 md:px-3 md:gap-5">
